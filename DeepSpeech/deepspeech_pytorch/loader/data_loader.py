...
class SpectrogramDataset(Dataset, SpectrogramParser):
    def __init__(self,
        ...
        self.language = audio_conf.language
    ...
    def parse_transcript(self, transcript_path):
        ...
        if self.language == 'english':
            ...
            while (y < len(P)):
                if y < len(P) - 1:
                    if P[y] == 'ɑ' and P[y + 1] == 'ː':
                        L.append(6)
                        y += 2
                    elif P[y] == 'i' and P[y + 1] == 'ː':
                        L.append(8)
                        y += 2
                    elif P[y] == 'ɜ' and P[y + 1] == 'ː':
                        L.append(9)
                        y += 2
                    elif P[y] == 'ɔ' and P[y + 1] == 'ː':
                        L.append(10)
                        y += 2
                    elif P[y] == 'u' and P[y + 1] == 'ː':
                        L.append(11)
                        y += 2
                    elif P[y] == 'e' and P[y + 1] == 'ɪ':
                        L.append(15)
                        y += 2
                    elif P[y] == 'ɔ' and P[y + 1] == 'ɪ':
                        L.append(16)
                        y += 2
                    elif P[y] == 'a' and P[y + 1] == 'ɪ':
                        L.append(17)
                        y += 2
                    elif P[y] == 'o' and P[y + 1] == 'ʊ':
                        L.append(18)
                        y += 2
                    elif P[y] == 't' and P[y + 1] == 'ʃ':
                        L.append(32)
                        y += 2
                    elif P[y] == 'd' and P[y + 1] == 'ʒ':
                        L.append(33)
                        y += 2
                    else:
                        L.append(self.labels_map.get(P[y]))
                        y += 1
                else:
                    L.append(self.labels_map.get(P[y]))
                    y += 1
            ...
            while (y < len(P)):
                if y < len(P) - 1:
                    if P[y] == 'ɑ' and P[y + 1] == '̃':
                        L.append(21)
                        y += 2
                    elif P[y] == 'ɔ' and P[y + 1] == '̃':
                        L.append(26)
                        y += 2
                    elif P[y] == 'ɛ' and P[y + 1] == '̃':
                        L.append(29)
                        y += 2
                    elif P[y] == 'œ' and P[y + 1] == '̃':
                        L.append(31)
                        y += 2
                    elif P[y] == 'a' and P[y + 1] == 'ː':
                        L.append(19)
                        y += 2
                    elif P[y] == 'o' and P[y + 1] == 'ː':
                        L.append(22)
                        y += 2
                    else:
                        L.append(self.labels_map.get(P[y]))
                    ...
                    L.append(self.labels_map.get(P[y]))
                    y += 1
        elif self.language == 'french_txt' or self.language == 'english_txt':
            L = []
            P = list(transcript)
            y = 0
            while (y < len(P)):
            ...
            print('ERROOOOOOR NO LANGUAGE')


            # transcript = list(filter(None, [self.labels_map.get(x) for x in list(transcript)]))
            # transcript = diction(transcript,self.labels_map)
...
class DSElasticDistributedSampler(DistributedSampler):
    ...
    def __init__(self, dataset, num_replicas=None, rank=None, batch_size=1):
        ...
        #print('nb files', len(ids))
        self.bins = [ids[i:i + self.batch_size] for i in range(0, len(ids), self.batch_size)]
        self.num_samples = int(
            math.ceil(float(len(self.bins) - self.start_index) / float(self.num_replicas))
        )
        #print('nbsamples', self.num_samples, 'nb replic', self.num_replicas)
