...
```
python -u train.py data.train_path=CommonVoice_dataset_english/commonvoice_train_manifestenrealJZ.json data.val_path=CommonVoice_dataset_english/commonvoice_dev_manifestenrealJZ.json trainer.gpus=1 data.labels_path=CommonVoice_dataset_english/labels_englishJZ.json data.batch_size=32 checkpoint.save_top_k=4 checkpoint.monitor="cer" checkpoint.verbose=True  trainer.resume_from_checkpoint=/gpfswork/rech/jnf/urm17su/test_deep/dt/UCR_en/outputs/2021-06-18/09-35-11/lightning_logs/version_245153/checkpoints/epoch_17-step_131615.ckpt
```
