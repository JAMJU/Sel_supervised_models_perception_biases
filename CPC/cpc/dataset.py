...
class AudioBatchData(Dataset):
    ...
    def __init__(self,
        ...
        """
        # print('\n    The Sequence names in AudioBatchData : \n     {} \n     {}  \n'.format(seqNames[0], seqNames[10]))
    ...
    def prepare(self):
        ...
        print('TEST 1st seq ####################################')
        test = extractLength(self.seqNames[0])
        print('############################# test', test)
        allLength = self.reload_pool.map(extractLength, self.seqNames)
        # print('\n    ALL LENGTH: \n    {} \n    {}'.format(allLength[0], allLength[10]))
        # print('\n    SeqNames: \n    {} \n    {}'.format(self.seqNames[0], self.seqNames[10]))
...
def extractLength(couple):
    ...
    return info.num_channels * info.num_frames# info.length
...
def findAllSeqs(dirName,
                ...
                loadCache=False,
                speaker_level=1):
    print('\n    Find all seqs arguments: \n    dirName: {} \n    loadCache: {} \n    speaker_level: {} \n'.format(dirName, loadCache, speaker_level))
    r"""
...
if __name__ == '__main__':
    ...
    seqNames, speakers = findAllSeqs('/gpfsscratch/rech/rnt/uuj49ar/CommonVoice/cv-corpus-6.1-2020-12-11/en/clips_wav/',
                                     extension='.wav',
                                     loadCache=False)
    ...
    trainDataset = AudioBatchData('/gpfsscratch/rech/rnt/uuj49ar/CommonVoice/cv-corpus-6.1-2020-12-11/en/clips_wav/',
                                  20480,
                                  seqTrain,
                                  phoneLabels,
                                  len(speakers),
