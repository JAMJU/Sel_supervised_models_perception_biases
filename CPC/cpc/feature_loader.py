...
from cpc.model import CPCModel, ConcatenatedModel
...
def loadModel(pathCheckpoints, loadStateDict=True):
    ...
    print(f"Concatenated model extractions {models} {len(models)}")
...
if __name__ == '__main__':
    cpcModel, hiddenGar, hiddenEncoder = loadModel(['/gpfswork/rech/rnt/uuj49ar/cpc_model/checkpoints/CommonVoice/third_french/checkpoint_2.pt'])
